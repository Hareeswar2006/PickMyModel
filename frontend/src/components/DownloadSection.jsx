      ...
      <div className="artifacts-grid">
        <div className="artifact-card">
          ...
          <div className="artifact-content">
            <h5 className="artifact-title">Model</h5>
            <p className="artifact-meta">• Best Performing Algorithm</p>
          </div>
          <a
        ...
        <div className="artifact-card">
          ...
          <div className="artifact-content">
            <h5 className="artifact-title">Dataset</h5>
            <p className="artifact-meta">• Scaling & Encoding</p>
          </div>
          <a
